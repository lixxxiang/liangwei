...
class AllInfoEditRepository @Inject constructor() {
...
//                "59.110.162.194:5201" +
    ...
    fun listexaminfo(pagenum: String, pageSize: String): Observable<ListExamInfoBean> {
        return RetrofitFactory("http://" +
                "59.110.161.48:8088" +
//                "59.110.162.194:5201" +
                "/").create(ApiService::class.java).listexaminfo(pagenum, pageSize)
    }
    ...
    fun deleteexaminfo(ids: String): Observable<DeleteExamInfoBean>{
        return RetrofitFactory("http://" +
                "59.110.161.48:8088" +
//                "59.110.162.194:5201" +
                "/").create(ApiService::class.java).deleteexaminfo(ids)
    }
    ...
    fun deleteillegalinfo(ids: String): Observable<DeleteIllegalInfoBean>{
        return RetrofitFactory("http://" +
                "59.110.161.48:8088" +
//                "59.110.162.194:5201" +
                "/").create(ApiService::class.java).deleteillegalinfo(ids)
    }
}