...
public class IllegalArchitecturalContoursAdapter extends BaseAdapter {
    ...
    private IllegalArchitecturalContoursFragment fragment;
    ...
    public IllegalArchitecturalContoursAdapter(SearchBean searchBean, Context context, IllegalArchitecturalContoursFragment fragment) {
