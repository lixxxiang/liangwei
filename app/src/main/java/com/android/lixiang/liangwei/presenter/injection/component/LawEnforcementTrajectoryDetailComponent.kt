...
import com.android.lixiang.liangwei.ui.fragment.area3.LawEnforcementTrajectoryDetailFragment
import com.android.lixiang.liangwei.ui.fragment.user.RegisterFragment
import dagger.Component

@ComponentScope
@Component(dependencies = arrayOf(FragmentComponent::class), modules = arrayOf(LawEnforcementTrajectoryDetailModule::class))
interface LawEnforcementTrajectoryDetailFragmentComponent {
    fun inject(fragment: LawEnforcementTrajectoryDetailFragment)
}